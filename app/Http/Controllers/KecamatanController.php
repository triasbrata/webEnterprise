...
class KecamatanController extends BaseController
{
	...
	function __construct(Kecamatan $model) {
		$this->model = $model;
		$this->formLocation = 'kecamatan.form';
		parent::__construct();
	}
	...
	public function index()
	{
		...
		return view('kecamatan.index',compact('data','session'));
		//sama saja dengan
	...
	public function create()
	{
		...
		return view('kecamatan.create',compact('form','session'));
	}
	...
	public function edit($id)
	{
		...
		$session = $this->session;
		$form = $this->formLocation;
		return view('kecamatan.edit',compact('form','session','data'));
	}
	...
	{
		$this->model = $this->model->find($id);
		return $this->model->delete()  ? redirect()->route('kecamatan.index')->with('success','Agama Berhasil dihapus') : redirect()->back() ;
	}
