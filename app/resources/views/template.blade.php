...
<html>
  <head>
    ...
    <title>Cloud Kartu Keluarga | TI</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Clodu</b>Kartu Keluarga</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         ...
         <ul class="sidebar-menu">
           ...
           <li class="header">DATA KARTU KELUARGA</li>
           <li> <a href="{{url('penduduk')}}"> <i class="fa fa-book"></i> <span>Data Penduduk</span><i class="fa fa-angle-right pull-right"></i> </a> </li>
           <li> <a href="{{url('kartu_keluarga')}}"> <i class="fa fa-book"></i> <span>Data Kartu Keluarga</span><i class="fa fa-angle-right pull-right"></i> </a> </li>
           <li class="header">MANAJEMEN KARTU KELUARGA</li>
           <li class="treeview">
             <a href="#">
             <i class="fa fa-book"></i> <span>Kartu Keluarga</span> <i class="fa fa-angle-right pull-right"></i>
             </a>
             <ul class="treeview-menu">
               <li><a href={{url('penduduk')}}><i class="fa fa-circle-o"></i>Kelola Data Personal</a></li>
           ...
           <li class="header">DATA REGIONAL</li>
           <li class="treeview">
